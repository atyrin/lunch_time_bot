...
export abstract class CommonZomatoRestaurant implements TranslatableRestaurant {
    protected URL: string;
    
    constructor(restaurandId:number){
        this.URL = `https://developers.zomato.com/api/v2.1/dailymenu?res_id=${restaurandId}`;
    }
